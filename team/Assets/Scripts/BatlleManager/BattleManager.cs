...
public class BattleManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI playerActionLogText;  // プレイヤーの行動ログ表示用
    public TextMeshProUGUI enemyActionLogText;  // 敵の行動ログ表示用
    public TextMeshProUGUI turnLogText;  // ターン処理(PP切れ・AP不足・勝敗など)のログ表示用
    ...
    // ターン処理系(PP切れ・AP不足・撃破・勝敗など)のログを表示する
